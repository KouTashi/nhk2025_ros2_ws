...
static const _ImuGpsRaw_type_support_symbol_names_t _ImuGpsRaw_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wit_msgs, msg, ImuGpsRaw)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wit_msgs, msg, ImuGpsRaw)),
  }
};
...
{
  return &::wit_msgs::msg::rosidl_typesupport_cpp::ImuGpsRaw_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wit_msgs, msg, ImuGpsRaw)() {
  return get_message_type_support_handle<wit_msgs::msg::ImuGpsRaw>();
}
