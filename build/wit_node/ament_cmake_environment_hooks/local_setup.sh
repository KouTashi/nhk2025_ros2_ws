...
: ${AMENT_CURRENT_PREFIX:="/home/dev/ros2_ws/install/wit_node"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/wit_node/environment/library_path.sh"
